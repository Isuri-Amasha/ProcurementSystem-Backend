...
//    public List<Order> getOrdersByUserId(String vendorId){
//        List<Order> orders = (List<Order>) orderRepository.findAllById(Collections.singleton(vendorId));
//
//        return orders;
//    }
//
...
//    }
    ...
    public List<Order> getOrdersByUserName(String vendorName) {
        return orderRepository.findByVendorName(vendorName);
    }


    //get Approved orders
    public List<Order> getApprovedOrdersByUserId(String vendorId){
    ...
    //get Rejected orders
    public List<Order> getRejectedOrdersByUserId(String vendorId){
        List<Order> orders = orderRepository.findByVendorId(vendorId);
        List<Order> finalList = new ArrayList<>();
        for (Order order : orders){
            if (order.getApprovalStatus().equals("Rejected")){
    ...
    //get Rejected orders
    public List<Order> getPendingOrdersByUserId(String vendorId){
        List<Order> orders = orderRepository.findByVendorId(vendorId);
        List<Order> finalList = new ArrayList<>();
        for (Order order : orders){
            if (order.getApprovalStatus().equals("Pending")){
    ...
    //get Rejected orders
    public List<Order> getAutomaticallyApprovedOrdersByUserId(String vendorId){
        List<Order> orders = orderRepository.findByVendorId(vendorId);
        List<Order> finalList = new ArrayList<>();
        for (Order order : orders){
            if (order.getApprovalStatus().equals("Automatically Approved")){
    ...
    public List<Order> getDeliveredOrdersByUserId(String vendorId){
        List<Order> orders = orderRepository.findByVendorId(vendorId);
        List<Order> finalList = new ArrayList<>();
        for (Order order : orders){
            if (order.getDeliveryStatus().equals("Delivered")){
    ...
    public List<Order> getInProgressOrdersByUserId(String vendorId){
        List<Order> orders = orderRepository.findByVendorId(vendorId);
        List<Order> finalList = new ArrayList<>();
        for (Order order : orders){
            if(order.getApprovalStatus().equals("Approved") || order.getApprovalStatus().equals("Automatically Approved")) {
                if (order.getDeliveryStatus().equals("Pending")) {
                    finalList.add(order);
                }
            }
    ...
    //get Pending orders
    public List<Order> getPendingApprovalDelivery(){
        List<Order> orders = orderRepository.findAll();
        List<Order> finalList = new ArrayList<>();
        for (Order order : orders){
            if (order.getApprovalStatus().equals("Approved") || order.getApprovalStatus().equals("Automatically Approved")){
    ...
    //get Pending orders
    public List<Order> getPendingApprovalPayment(){
        List<Order> orders = orderRepository.findAll();
        List<Order> finalList = new ArrayList<>();
        for (Order order : orders){
            if (order.getApprovalStatus().equals("Approved") || order.getApprovalStatus().equals("Automatically Approved")){
